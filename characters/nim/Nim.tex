...
\Class{Rogue (\ClassOneValue) / Ranger (\ClassTwoValue)}
...
\CharismaScore{17}          % Rolled 6,5,4,1 = 15 + 1 (Halfling Lightfoot) + 1 (Second Chance) = 17
...
\MaxHitPoints{    \fpeval{
        ...
        6+ % Default increase at ranger level 2
        \ConstitutionModifierValue * \LevelValue % Total levels
    }
}

\MaxHitDice{\ClassOneValue d6+\ClassTwoValue d10}   % 4 from rogue, 1 from ranger
...
\AddWeapon{Longbow}{\fpeval{\ProficiencyValue+\DexterityModifierValue 
+ 2 % From Archery (Ranger Fighting Style)
}}{1d8 +
\DexterityModifierValue~/ % Because ranged weapon has dex modifier to damage
(x/180)-% Short bow has range 45/180 m, beyond 45 m you have disadvantage (my char has no disadvantage because has sharpshooter feat), you can not shoot beyond 180 m
p
}
...
\textbf{Weapons}: Simple weapons, martial weapons.\\ % From Ranger class
...
\EquipmentItem{Longbow}{1}{1} + \EquipmentItem{Arrows}{0.025}{20}, % From Rogue class
\EquipmentItem{Dagger}{0.5}{2}.\\% From Rogue class
\textbf{Armor}: \EquipmentItem{Studded Leather Armor}{6.5}{1}\\ % From Rogue class
...
\textbf{Second Chance}-> can \textbf{force enemy attack roll reroll} if you see the enemy. Reset after new combat (after initiative roll) or short rest.\\
...
\textbf{Barren}-> You can't conceive children.
}
...
\CharacterAppearance{
\includegraphics[width=5.7cm]{images/nim.png}
}
...
\AlliesAndOrganizations{
    \begin{itemize}
        ...
        \item Luna: A young Amazon recruit who admires Nimrielle and reminds her of her lost innocence.
    \end{itemize}
}

\OrganizationName{The Amazons
}
\OrganizationSymbol{\includegraphics[width=4.9cm,height=3.9cm]{images/amazons-banner}
}
...
\FirstLevelSpellSlotA{Hunter's Mark} % https://dnd5e.wikidot.com/spell:hunters-mark
\FirstLevelSpellSlotAPrepared{True}
\FirstLevelSpellSlotB{Hails of Thorns}
\FirstLevelSpellSlotBPrepared{True}
\FirstLevelSpellSlotC{} % ensnaring smoke
...
\section{Combat Action Guide}

\subsection{Offense}
\begin{enumerate}[label=\Alph*), itemsep=1.5em]

% --- Longbow blob ---
\item \textbf{Longbow — Long Range + Hidden + Multiple Enemies (Blob)}
    \begin{enumerate}[label=\arabic*.]
        \item Spell: \href{https://dnd5e.wikidot.com/spell:hail-of-thorns}{\textit{Hail of Thorns}} (if spell slot available)
        \item Position: Hidden → gain advantage
        \item Feat: \href{https://dnd5e.wikidot.com/feat:sharpshooter}{Sharpshooter} (-5 to attack bonus, +10 damage)
        \item Class Feature: \href{https://dnd5e.wikidot.com/rogue\#:~:text=gain\%20this\%20benefit.-,Sneak\%20Attack,-Beginning\%20at\%201st}{Sneak Attack} (applies because of advantage)
        \item Damage Calculation: Weapon dmg (1d8 + Dex) + Sneak Attack (2d6) + Sharpshooter (+10) + Hail of Thorns
        \item Spell Note: Hail of Thorns damage repeats for every attack hit until concentration ends (1 min)
        \item Bonus Action to get advantage on next turn:
        \begin{itemize}
            \item \href{https://roll20.net/compendium/dnd5e/Combat\#toc_27}{Hide} → leverage \href{https://dnd5e.wikidot.com/lineage:halfling\#:~:text=increases\%20by\%201.-,Naturally\%20Stealthy,-.\%20You\%20can}{\textbf{Natural Stealthy}}
            \item  \textbf{OR} \href{https://dnd5e.wikidot.com/rogue\#:~:text=Psionic\%20Options\%20Revisited-,Steady\%20Aim,-(Optional)}{Steady Aim} (if no advantage)
        \end{itemize}
    \end{enumerate}

% --- Longbow scattered with Hunter's Mark ---
\item \textbf{Longbow — Long Range + Hidden + Multiple Enemies (Scattered)}
    \begin{enumerate}[label=\arabic*.]
        \item Spell: \href{https://dnd5e.wikidot.com/spell:hunters-mark}{\textit{Hunter's Mark}} (if spell slot available)
        \item Position: Hidden → gain advantage
        \item Feat: \href{https://dnd5e.wikidot.com/feat:sharpshooter}{Sharpshooter} (-5 to attack bonus, +10 damage)
        \item Class Feature: \href{https://dnd5e.wikidot.com/rogue\#:~:text=gain\%20this\%20benefit.-,Sneak\%20Attack,-Beginning\%20at\%201st}{Sneak Attack} (applies because of advantage)
        \item Damage Calculation: Weapon dmg (1d8 + Dex) + Sneak Attack (2d6) + Sharpshooter (+10) + Hunter's Mark
        \item Spell Note: Hunter's Mark damage repeats for every attack hit until concentration ends (1 hour)
        \item Bonus Action to get advantage on next turn:
        \begin{itemize}
            \item \href{https://roll20.net/compendium/dnd5e/Combat\#toc_27}{Hide} → leverage \href{https://dnd5e.wikidot.com/lineage:halfling\#:~:text=increases\%20by\%201.-,Naturally\%20Stealthy,-.\%20You\%20can}{\textbf{Natural Stealthy}}
            \item  \textbf{OR} \href{https://dnd5e.wikidot.com/rogue\#:~:text=Psionic\%20Options\%20Revisited-,Steady\%20Aim,-(Optional)}{Steady Aim} (if no advantage)
...
% --- Longbow scattered with Favored Foe ---
\item \textbf{Longbow — Long Range + Hidden + Multiple Enemies (Scattered, Alternate)}
    \begin{enumerate}[label=\arabic*.]
        \item Feature: \href{https://dnd5e.wikidot.com/ranger\#:~:text=on\%20your\%20adventures.-,Favored\%20Foe,-(Optional)}{Favored Foe} (if available)
        \item Position: Hidden → gain advantage
        \item Feat: \href{https://dnd5e.wikidot.com/feat:sharpshooter}{Sharpshooter} (-5 to attack bonus, +10 damage)
        \item Class Feature: \href{https://dnd5e.wikidot.com/rogue\#:~:text=gain\%20this\%20benefit.-,Sneak\%20Attack,-Beginning\%20at\%201st}{Sneak Attack} (applies because of advantage)
        \item Damage Calculation: Weapon dmg (1d8 + Dex) + Sneak Attack (2d6) + Sharpshooter (+10) + Favored Foe
        \item Feature Note: Favored Foe damage repeats for every attack hit until concentration ends (1 min)
        \item Bonus Action to get advantage on next turn:
        \begin{itemize}
            \item \href{https://roll20.net/compendium/dnd5e/Combat\#toc_27}{Hide} → leverage \href{https://dnd5e.wikidot.com/lineage:halfling\#:~:text=increases\%20by\%201.-,Naturally\%20Stealthy,-.\%20You\%20can}{\textbf{Natural Stealthy}}
            \item  \textbf{OR} \href{https://dnd5e.wikidot.com/rogue\#:~:text=Psionic\%20Options\%20Revisited-,Steady\%20Aim,-(Optional)}{Steady Aim} (if no advantage)
...
% --- Rapier melee ---
\item \textbf{Rapier — Melee}
    \begin{enumerate}[label=\arabic*.]
        \item Feature: \href{https://dnd5e.wikidot.com/ranger\#:~:text=on\%20your\%20adventures.-,Favored\%20Foe,-(Optional)}{Favored Foe} (if available)
        \item Position: Hidden → gain advantage
        \item Class Feature: \href{https://dnd5e.wikidot.com/rogue\#:~:text=gain\%20this\%20benefit.-,Sneak\%20Attack,-Beginning\%20at\%201st}{Sneak Attack} (applies because of advantage)
        \item Damage Calculation: Weapon dmg (1d8 + Dex) + Sneak Attack (2d6) + Favored Foe
        \item Bonus Action:
        \begin{itemize}
            \item \href{https://roll20.net/compendium/dnd5e/Combat\#toc_23}{Dash} / \href{https://roll20.net/compendium/dnd5e/Combat\#toc_24}{Disengage} → reposition safely
            \item \textbf{OR} \href{https://roll20.net/compendium/dnd5e/Combat\#toc_27}{Hide} → leverage \href{https://dnd5e.wikidot.com/lineage:halfling\#:~:text=increases\%20by\%201.-,Naturally\%20Stealthy,-.\%20You\%20can}{\textbf{Natural Stealthy}}
        \end{itemize}
...
\subsection{Defense}
\begin{itemize}
    \item Reaction: \href{https://dnd5e.wikidot.com/rogue:scout#:~:text=Guide%20to%20Everything-,Skirmisher,-Starting%20at%203rd}{Skirmisher}
    \item Feature: \href{https://dnd5e.wikidot.com/feat:second-chance}{Second Chance}
\end{itemize}

\subsection{Combat sequences}
\begin{enumerate}
    \item First turn A/C then B or D if melee.
\end{enumerate}
...
During those early days of recovery, the priestesses and healers of the Amazon Clan uncovered wounds that went far deeper than bruises or broken bones. The long years of brutality at the hands of the orcs had left permanent marks on her body, and the healers eventually delivered the quiet verdict: the repeated abuse had rendered her barren.\\
...
\begin{quote}
   \textit{Nimrielle Needleswift.}\\
    ...
    \textit{Come alone.}
\end{quote}
Nim's stomach tightened. No one knew her by her full name \textit{Nimrielle Needleswift} except some Amazons and no one except Luna knew what she did, but she would have never betrayed her. She read the words again, and a chill unlike any winter frost crept down her spine. It was not merely the cold of the North Sword Coast that struck her—it was the terror of the unknown. Someone knew. Someone had uncovered her carefully hidden past. And for the first time, two thoughts twisted together in a knot of fear: that Luna—her young protégé, innocent and trusting—might have been trapped, forced to betray her, or worse, that Luna herself could be the one who wrote the letter. Regardless, the message was clear: \textit{Someone} knew. And that \textit{Someone} now demanded her presence.\\
