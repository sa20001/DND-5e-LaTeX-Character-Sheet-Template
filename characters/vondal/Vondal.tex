...
\textbf{Cloud Rune}-> can \textbf{deflect} attack on ally (in a 9m radius) to an enemy (in same radius). Once for short rest.\\
\textbf{Fire rune}-> 2d6 fire damage on hit and target restrained, dmg repeat each turn till successful Str saving throw. Once per short rest.
\\
\\
...
\AlliesAndOrganizations{
    ...
    \begin{itemize}
        \item Bloodaxes Mercenary Company
        \item Tempus Temple in Tunkhlbalt
    \end{itemize}
}
...
\OrganizationSymbol{
    \includegraphics[width=4.9cm,height=3.9cm]{images/blood_axes.png}
}
