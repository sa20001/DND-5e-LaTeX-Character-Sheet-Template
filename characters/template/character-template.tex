...
% Level of classes
\ClassOne{0}    % Main class
% \ClassTwo{0}    % Secondary class
% \ClassThree{0}  % Tertiary class
% \ClassFour{0}   % Quaternary class

% adds only main class and total level to prevent overflow
\Class{Character class here (\ClassOne{0})}
