...
\CharacterAppearance{
\includegraphics[width=5.75cm]{characters/images/grok.png}
}
...
\OrganizationSymbol{
    \includegraphics[width=4.9cm,height=3.9cm]{characters/images/Neverwinter_symbol}
}
